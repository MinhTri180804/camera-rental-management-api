import { IOtpEmailForgotPasswordService } from '@modules/auth/forgot-password/domain';
import { Injectable } from '@nestjs/common';
import { BaseOtpService } from '@shared/infrastructure';
import crypto, { createHash } from 'crypto';

@Injectable()
export class OtpEmailForgotPasswordServiceIml
  extends BaseOtpService
  implements IOtpEmailForgotPasswordService
{
